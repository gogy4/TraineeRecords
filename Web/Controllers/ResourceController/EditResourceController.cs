...
public class EditResourceController(TraineeServices traineeServices, CurrentProjectServices currentProjectServices, InternshipDirectionsServices internshipDirectionsServices) : Controller
{
    public async Task<IActionResult> Index(Guid resourceId, string resourceType)
    {
        ...
        var resourceName = resourceType == "Direction" ? (await internshipDirectionsServices.GetById(resourceId)).Name : (await currentProjectServices.GetById(resourceId)).Name;
